...
Ключевые различия
Аутентификация: процесс подтверждения личности пользователя ("Кто вы?"). Пользователь доказывает, что он тот, за кого себя выдаёт.
Авторизация: процесс определения прав доступа уже аутентифицированного пользователя ("Что вам разрешено делать?"). Всегда происходит после аутентификации.
